...
#define __KERNEL_HEADERS__ "/opt/clone/LSDK-10.2.00082-4/build/buildroot-2009.08/toolchain_build_mips/linux/include"
...
#define __CROSS_COMPILER_PREFIX__ "/opt/mips-gcc-4.3.3-uClibc-0.9.30/usr/bin/mips-linux-uclibc-"
