...
{
	if(INET_validv4addr(get("", "SrcIPv4AddressRangeStart"))==0 || INET_validv4addr(get("", "DestIPv4AddressRangeStart"))==0 || isdigit(get("", "PortRangeStart"))==0)
	{
		$result = "ERROR";
		break;
	}
	else if(get("", "SrcIPv4AddressRangeEnd")!="" && INET_validv4addr(get("", "SrcIPv4AddressRangeEnd"))==0)
	{
		$result = "ERROR";
		break;
	}
	else if(get("", "DestIPv4AddressRangeEnd")!="" && INET_validv4addr(get("", "DestIPv4AddressRangeEnd"))==0)
	{
		$result = "ERROR";
		break;
	}
	else if(get("", "PortRangeEnd")!="" && isdigit(get("", "PortRangeEnd"))==0)
	{
		$result = "ERROR";
		break;
	}
