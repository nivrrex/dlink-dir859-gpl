...
{
	if($result != "OK") {break;}
	$NickName	= get("", $nodebase."ClientInfoLists/ClientInfo/NickName");
	$ReserveIP	= get("", $nodebase."ClientInfoLists/ClientInfo/ReserveIP");
	//Skip too many reservation IP check if nick name and reserve IP are empty.
	if($NickName=="" && $ReserveIP=="")	{break;}
	$dhcps4_name = get("", "uid");
