...
else
{
	...
	{ $wlanMode = "ac"; }	
	else if( $mode == "802.11nac" || $mode == "802.11acn")
	{ $wlanMode = "acn"; }
	else if( $mode == "802.11anac" || $mode == "802.11acna" )
	{ $wlanMode = "acna"; }	
	else if( $mode == "802.11abgn" ) //for Android QRS mobile
	{ $wlanMode = get("",$path_phyinf_wlan."/media/wlmode"); }	
	else
	{ 
		if( $wlanEn == "1" && $radioID != "RADIO_2.4G_Guest" && $radioID != "RADIO_2.4GHz_Guest" && $radioID != "RADIO_5G_Guest" && $radioID != "RADIO_5GHz_Guest") { $result = "ERROR_BAD_MODE"; } //Sammy
	}
	if( $wlanEn == "1" && $ssid == "" )
	{ $result = "ERROR"; }
