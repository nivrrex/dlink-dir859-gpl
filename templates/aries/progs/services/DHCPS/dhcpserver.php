...
function dhcps4start($inf, $phyinf, $dhcpsp)
{
	...
	/* TR069 for TR-111*/
	if(isfile("/usr/sbin/tr069c") == 1){
		$tr069_host_helper = "/etc/scripts/tr069/tr069_host.sh";
		fwrite("a",$udhcpd_conf, "tr069_hosthelper ".$tr069_host_helper."\n");
		fwrite("a",$udhcpd_conf, "tr069_manufactureroui ".query("/tr069/deviceinfo/manufactureroui")."\n");
		fwrite("a",$udhcpd_conf, "tr069_serialnumber ".query("/tr069/deviceinfo/serialnumber")."\n");
		fwrite("a",$udhcpd_conf, "tr069_productclass ".query("/tr069/deviceinfo/productclass")."\n");
	}
