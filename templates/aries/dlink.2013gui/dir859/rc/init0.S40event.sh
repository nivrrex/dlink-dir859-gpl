...
event WAN-1.UP		insert "service HW_NAT restart"
event WAN-1.DOWN	add "service INFSVCS.WAN-1 stop"
event WAN-1.DOWN	insert "service HW_NAT restart"
...
# IPv6 DAD
event WANPORT.LINKUP insert "IPv6DAD:phpsh /etc/scripts/ipv6-WANPORT-UP.php"
#event WANPORT.LINKUP insert "HWNAT:service HW_NAT restart"
