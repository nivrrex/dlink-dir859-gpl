...
function phyinf_setmedia($layout, $ifname, $media)
{
	...
	if($media=="AUTO")
	{
		startcmd("ethreg -i eth0 -p ".$port." 0x9=0x0200");
		startcmd("ethreg -i eth0 -p ".$port." 0x4=0x1de1");
		startcmd("ethreg -i eth0 -p ".$port." 0x0=0x3100");
	...
	else
	{
		...
		startcmd("ethreg -i eth0 -p ".$port." 0x9=".$reg9);
		startcmd("ethreg -i eth0 -p ".$port." 0x4=".$reg4);
		startcmd("ethreg -i eth0 -p ".$port." 0x0=".$reg0);
	}
	stopcmd("ethreg -i eth0 -p ".$port." 0x9=0x0200");
	stopcmd("ethreg -i eth0 -p ".$port." 0x4=0x1de1");
	stopcmd("ethreg -i eth0 -p ".$port." 0x0=0x3100");
