...
xmldbc -P /etc/scripts/wps/wps.php -V PARAM1=save -V PARAM2=REPEATER -V BAND=5G -V SSID="$1" -V AUTHMODE=$2 -V ENCRTYPE=$3 -V KEYINDEX=$4 -V KEYSTR="$5" > /var/run/wps_repeater_5G.sh
