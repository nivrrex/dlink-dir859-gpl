...
else if($authtype=="WPAPSK"|| $authtype=="WPA2PSK" ||$authtype=="WPA+2PSK")
{
	...
	if		($wlmode == "a")			{$wlmode = 7; $gmode="0"; $nmode="0";}
	else if ($wlmode == "an")		{$wlmode = 9; $gmode="0"; $nmode="1";}
	else if	($wlmode == "bgn")	{$wlmode = 6; $gmode="1"; $nmode="1";}
	else if ($wlmode == "bg")		{$wlmode = 3; $gmode="1"; $nmode="0";}
	else if ($wlmode == "n")	
	{
		if ($freq == "5" || $freq == 5 ) 	{ $wlmode = 8; } 
		else 								{ $wlmode = 4; }	
	...
	else if ($wlmode == "ac")		{$wlmode = 10; $gmode="0"; $nmode="1";}
	else if ($wlmode == "acn")	{$wlmode = 11; $gmode="0"; $nmode="1";}
	else if ($wlmode == "acna")	{$wlmode = 12; $gmode="0"; $nmode="1";}
	else
	{
		/* use 'bgn' as default.*/
		TRACE_info("rtcfg (broadcom conf): Not supported wireless mode: [".$wlmode."].Use 'bng' as default wireless mode.");
		$wlmode = 6;	$gmode="1"; $nmode="1";
	}
	if($can_support_n_mode==0)	{$nmode="0";}
	...
	*/
	if ($wlmode == 4 || $wlmode == 8 || $wlmode == 11)
	{
