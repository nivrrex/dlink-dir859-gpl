...
if [ "$1" = "start" ]; then
	...
	event "STATUS.CRITICAL"		add "usockc /var/gpio_ctrl INET_ORANGE_ON"
...
#	event "STATUS.AMBER.BLINK.FAST"		add "usockc /var/gpio_ctrl STATUS_AMBER_BLINK_FAST"
	...
	event "WAN-1.PPP.ONDEMAND"	insert "WANLED:phpsh /etc/scripts/update_wanled.php EVENT=WAN_PPP_ONDEMAND"
 	event "WAN-1.PPP.MANUAL" insert "WANLED:phpsh /etc/scripts/update_wanled.php EVENT=WAN_LINKUP"
 	event "WAN-1.PPP.SCHEDULE" insert "WANLED:phpsh /etc/scripts/update_wanled.php EVENT=WAN_LINKUP"
	...
	event "WEBSET.RENEW"	insert "WANLED:phpsh /etc/scripts/update_wanled.php EVENT=WAN_RENEW"
