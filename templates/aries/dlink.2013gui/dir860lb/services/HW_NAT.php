...
{
	//Currently always enable hw nat for MT7621 with Dlink new gui
...
if ($layout=="router")
{
	...
	//startcmd("insmod /lib/modules/hw_nat.ko\n");
	//HWNATsetup($dis_hwnat_flag,$dis_fastnat_flag,$dis_alpha_nat_flag,$wan_mode);
	...
	*/
	...
	{
		if($dis_hwnat_flag == 0) $dis_alpha_nat_flag=1;
	}
