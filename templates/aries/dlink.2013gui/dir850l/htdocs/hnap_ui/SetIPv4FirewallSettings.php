...
foreach($node_rule)
{
	...
	if(ipv4hostid($SrcIPv4AddressRangeStart, "0") > ipv4hostid($SrcIPv4AddressRangeEnd, "0"))
	{
	...
	if(ipv4hostid($DestIPv4AddressRangeStart, "0") > ipv4hostid($DestIPv4AddressRangeEnd, "0"))
	{
