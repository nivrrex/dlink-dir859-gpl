...
function startcmd($cmd) {if(query("/device/disable_nat")!="1") fwrite(a, $_GLOBALS["START"], $cmd."\n"); }
function stopcmd($cmd) {if(query("/device/disable_nat")!="1") fwrite(a, $_GLOBALS["STOP"], $cmd."\n"); }
...
//marco, for cone	
	...
	{
		TRACE_debug("set ip_forward");
		fwrite(a, $_GLOBALS["START"], "echo 1 > /proc/sys/net/ipv4/ip_forward\n");
		//re-clean iptables chain again
		fwrite(a, $_GLOBALS["START"], "iptables -F\n");
		fwrite(a, $_GLOBALS["START"], "iptables -X\n");
		fwrite(a, $_GLOBALS["START"], "iptables -t nat -F\n");
		fwrite(a, $_GLOBALS["START"], "iptables -t nat -X\n");
		fwrite(a, $_GLOBALS["START"], "iptables -t mangle -F\n");
		fwrite(a, $_GLOBALS["START"], "iptables -t mangle -X\n");
		fwrite(a, $_GLOBALS["START"], "iptables -P INPUT ACCEPT\n");
		fwrite(a, $_GLOBALS["START"], "iptables -P FORWARD ACCEPT\n");
		fwrite(a, $_GLOBALS["START"], "iptables -P OUTPUT ACCEPT\n");
	}
}
