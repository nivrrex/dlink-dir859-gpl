...
{
	<?
		if($FEATURE_NOIPV6 != "0") echo 'services: "DDNS4.WAN-1, DDNS4.WAN-3, RUNTIME.DDNS4.WAN-1, RUNTIME.PHYINF",';
		else echo 'services: "DDNS6.WAN-1,DDNS4.WAN-1, DDNS4.WAN-3, RUNTIME.DDNS4.WAN-1, RUNTIME.PHYINF",';
	?>
	...
	g_edit: 0,
	ipv6_feature: <?
		if($FEATURE_NOIPV6!="0") echo "false";
		else echo "true";
	?>,
	...
	PreSubmit: function()
	{
		...
		if (this.ipv6_feature) var p6 = PXML.FindModule("DDNS6.WAN-1");		
