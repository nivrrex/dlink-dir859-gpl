...
function ModelInfo(modelName, hwVer, fwVer, fwRegion)
{
	this.modelName = modelName;
	this.hwVer = hwVer;
	this.fwVer = fwVer;
	this.fwRegion = fwRegion;
}
...
function getDeviceInfo()
{
	...
	.done(function(obj)
	{
		...
		var modelInfo = new ModelInfo(obj.ModelName, obj.HardwareVersion, obj.FirmwareVersion, obj.FirmwareRegion);
