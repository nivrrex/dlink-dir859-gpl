    ...
    <GetWLanRadiosResponse xmlns="http://purenetworks.com/HNAP1/">
		...
		<?if($path_phyinf_wlan1==""){echo "<!--";}?>
			...
			<?
				...
				{
					echo "<SecurityInfo>\n";
					echo "	<SecurityType>WEP-AUTO</SecurityType>\n";
					echo "	<Encryptions>\n";
					...
					echo "</SecurityInfo>\n";
					echo "<SecurityInfo>\n";
					echo "	<SecurityType>WPA-TKIP</SecurityType>\n";
					echo "	<Encryptions>\n";
					...
					echo "</SecurityInfo>\n";
					echo "<SecurityInfo>\n";
					echo "	<SecurityType>WPA-AES</SecurityType>\n";
					echo "	<Encryptions>\n";
					echo "		<string>TKIP</string>\n";
					echo "		<string>AES</string>\n";
					echo "		<string>TKIPORAES</string>\n";
					...
					echo "</SecurityInfo>\n";
					echo "<SecurityInfo>\n";
					echo "	<SecurityType>WPA-TKIP+AES</SecurityType>\n";
					echo "	<Encryptions>\n";
					echo "		<string>TKIP</string>\n";
					echo "		<string>AES</string>\n";
					echo "		<string>TKIPORAES</string>\n";
					...
					echo "</SecurityInfo>\n";
					echo "<SecurityInfo>\n";
					echo "	<SecurityType>WPA2-TKIP</SecurityType>\n";
					echo "	<Encryptions>\n";
					echo "		<string>TKIP</string>\n";
					echo "		<string>AES</string>\n";
					echo "		<string>TKIPORAES</string>\n";
					...
					echo "</SecurityInfo>\n";
					echo "<SecurityInfo>\n";
					echo "	<SecurityType>WPA+WPA2-TKIP</SecurityType>\n";
					echo "	<Encryptions>\n";
					echo "		<string>TKIP</string>\n";
					echo "		<string>AES</string>\n";
					echo "		<string>TKIPORAES</string>\n";
					...
					echo "</SecurityInfo>\n";
					echo "<SecurityInfo>\n";
					echo "	<SecurityType>WPA+WPA2-AES</SecurityType>\n";
					echo "	<Encryptions>\n";
					echo "		<string>TKIP</string>\n";
					echo "		<string>AES</string>\n";
					echo "		<string>TKIPORAES</string>\n";
