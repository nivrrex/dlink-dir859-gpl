...
if($country=="KR")
{
	set("/device/passthrough/rtsp", "1"); //KR ver. rtsp default value = 1
	set("/dhcpc4/unicast", "yes");         //KR ver unicast default value = yes
...
if($country=="SG")
{
	$phy = XNODE_getpathbytarget("", "inf", "uid", "LAN-5", 0); 
	set($phy."/active", "0"); //ipv6 guest zone disable
}
