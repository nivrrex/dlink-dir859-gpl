...
function initialMenu()
{
	...
	var menu;
	if(devicemode=="WiFiAPMode" || devicemode=="WiFiAPClient")
	{
		menu = "<ul>";
	...
	else
	{
		...
		menu 		+= "		</ul>";
		menu 		+= "	</li>";
	menu 		+= "	<li class='parent' onmouseover='this.className=\"parentOn\"' onmouseout='this.className=\"parent\"'><a id='menu_Advanced' href='#'>"+I18N("j", "Advanced")+"</a>";
		menu 		+= "		<ul>";
