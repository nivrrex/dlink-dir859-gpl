...
function editDataGet(id)
{
	...
	if(tmp_editSourceAddressRangeStart == "undefined") 
	{
		tmp_editSourceAddressRangeStart = tmp_editSourceAddressRangeEnd;
	}
	...
	if(tmp_editDestinationAddressRangeStart == "undefined") 
	{
		tmp_editDestinationAddressRangeStart = tmp_editDestinationAddressRangeEnd;
	}
	...
	if(tmp_editPortRangeStart == "undefined") 
	{
		tmp_editPortRangeStart = tmp_editPortRangeEnd;
	}
	
	document.getElementById("FWv4_EditName").value = tmp_editName;
	if (tmp_editSourceAddressRangeStart==tmp_editSourceAddressRangeEnd)
	{
		document.getElementById("FWv4_EditSourceIPRange").value = tmp_editSourceAddressRangeEnd;
	}
	else{
	document.getElementById("FWv4_EditSourceIPRange").value = tmp_editSourceAddressRangeStart + "-" + tmp_editSourceAddressRangeEnd;
	}
	if (tmp_editDestinationAddressRangeStart==tmp_editDestinationAddressRangeEnd)
	{
		document.getElementById("FWv4_EditDestinationIPRange").value = tmp_editDestinationAddressRangeEnd;
	}
	else{
	...
	if(tmp_editPortRangeStart==tmp_editPortRangeEnd)
	{
		document.getElementById("FWv4_EditPortRange").value = tmp_editPortRangeEnd;
	}
	else{
...
function assignRowToIndex(id)
{
	...
	if (edit_Name != "")
	{
		...
		for (var _getName = 1; _getName <= Total_FirewallRules; _getName ++)
		{
			if (id == _getName)	{	Name_CheckList[getName_Row] = edit_Name;	}
			else	{	Name_CheckList[getName_Row] = tbl.rows[_getName].cells[0].childNodes[0].innerText;	}
			getName_Row ++;
		}
		for (var _checkName = 0; _checkName < Name_CheckList.length; _checkName ++)
		{
