...
if($result == "OK")
{
	...
	$path_dhcps4_lan1 = XNODE_getpathbytarget("dhcps4", "entry", "uid", query($path_inf_lan1."/dhcps4"), 0);
	
	$pro_path = XNODE_getpathbytarget("/internetprofile", "entry", "profiletype", "DHCP", 0);
	set($pro_path."/config/hostname", $devicename);
	
	set("/device/hostname", $devicename);
