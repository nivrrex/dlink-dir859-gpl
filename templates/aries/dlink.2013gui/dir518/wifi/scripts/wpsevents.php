...
$uid1 = "BAND24G-1.1";
$uid2 = "BAND5G-1.1";
$uid3 = "BAND24G-REPEATER";
$uid4 = "BAND5G-REPEATER";
...
//for wisp function ,client always do wps
if (query($wifi3."/wps/enable")==1) $wps_sta++;
if (query($wifi4."/wps/enable")==1) $wps_sta++;
