...
event WAN-6.UP		add "service INFSVCS.WAN-6 restart"
event WAN-6.DOWN	add "service INFSVCS.WAN-6 stop"
event WAN-7.UP		add "service INFSVCS.WAN-7 restart"
event WAN-7.DOWN	add "service INFSVCS.WAN-7 stop"
