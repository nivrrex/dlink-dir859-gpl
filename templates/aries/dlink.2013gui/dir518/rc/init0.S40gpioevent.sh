...
#	event "STATUS.CRITICAL"		add "usockc /var/gpio_ctrl STATUS_AMBER_BLINK"
	...
	event "WAN-3.CONNECTED"		add "usockc /var/gpio_ctrl INET_ON"
	event "WAN-3.DISCONNECTED"	add "usockc /var/gpio_ctrl INET_OFF"
	event "WAN-7.CONNECTED"		add "usockc /var/gpio_ctrl INET_ON"
	event "WAN-7.DISCONNECTED"	add "usockc /var/gpio_ctrl INET_OFF"
