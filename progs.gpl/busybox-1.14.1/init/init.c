...
static void parse_inittab(void)
{
...
#endif
	{
		...
		new_init_action(ASKFIRST, "/usr/sbin/login admin ''  -l/usr/sbin/cli -t3600 -cN ", ELBOX_PROGS_GPL_DEV_RUN_SHELL_PATH);
#else
...
#if 0  /* Jiasin, 2014/04/15, Reference busybox 1.14.1 */
