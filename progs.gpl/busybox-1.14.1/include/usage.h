...
#define wget_full_usage "\n\n" \
     ...
     "\n	--post-data    use the POST method; send STRING as the data(default do urlencode)." \
     "\n	--post-file    use the POST method; send contents of FILE." \          
     "\n	--nourlencode  NOT do URL encode for --post-data" \    
     "\n        --anourlencode NOT do URL encode for --post-data (Alpha)" \     
