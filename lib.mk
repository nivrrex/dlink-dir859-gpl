...
# $3: destination path
# $4: filenames
# usage: $(call replace_sign_and_install,signature,path_a,path_b,file_1 file_2 ...)
define replace_sign_and_install
	@for file in $4; do \
		sed -e 's|SiGnAtUrE|$1|' $2/$$file > $3/$$file; \
	done
endef

# function: xml_merge_and_install
# $1: signature
# $2: source path
# $3: destination path
# $4: filenames
# usage: $(call xml_merge_and_install,signature,path_a,path_b,file_1 file_2 ...)
define xml_merge_and_install
	@for file in $4; do \
		[ -d $3 ] || mkdir -p $3; \
		sed -e 's|SiGnAtUrE|$1|' $2/$$file > $3/$$file; \
	done
