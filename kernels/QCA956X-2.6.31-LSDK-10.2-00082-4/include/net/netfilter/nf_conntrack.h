...
#define FLAG_IN_HNAT	1
#define FLAG_TCP_WINDOW	1 << 1
#define FLAG_HNAT_DENY	1 << 2
	u_int8_t in_hnat;
	u_int8_t deny;
	u_int16_t ct_packets;
#endif
...
extern void * get_net_custom();
extern int set_net_custom(struct net *net);
#endif
/*
...
#ifdef CONFIG_ATHRS17_HNAT
extern void (*nf_ct_qca_nat_hook)(struct nf_conn *ct, unsigned int action);
#endif
