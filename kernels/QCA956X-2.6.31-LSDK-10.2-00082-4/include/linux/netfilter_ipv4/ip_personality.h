...
extern unsigned int ip_fakeos_enable;
...
struct ip_pers {
  ...
  u_int32_t isn_switch;  
  u_int32_t tcpwin_switch;
  u_int32_t http_hold_switch;
  u_int32_t optprog_switch;
  u_int32_t ttl_switch;
    u_int8_t  ttl_param;
...
struct ip_pers_conn_info {
  ...
  u_int32_t timestamp_scale;
  u_int32_t seq_pack1_split;
  u_int32_t seq_pack2_split;
  u_int32_t ip_checked;
  u_int32_t  ip_type;
};
...
#include <net/sock.h>
#include <net/route.h>
//#include <linux/netfilter_ipv4/nf_conntrack.h> by tsrites 2013-11-7
