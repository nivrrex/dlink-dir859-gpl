...
#define XMLDB_SETEXT	11	/* set extended get/set/customized attribute command */
#define XMLDB_GETEXT	12	/* get extended get/set/customized attribute command */
#define XMLDB_TIMER		13	/* schedule a timer */
#define XMLDB_KILLTIMER	14	/* kill a timer */
#define XMLDB_WRITE		15	/* write the subset of database to file */
