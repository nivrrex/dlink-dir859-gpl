...
#define ALOG_AP_EU 	(33<<3)  /* EU directive server log *//*syslogd_2014_11_12 , Ken*/

/* redefine LOG_NFACILITIES */
#ifdef LOG_NFACILITIES
#undef LOG_NFACILITIES
#endif
#define	LOG_NFACILITIES	33	/* current number of facilities */ /*syslogd_2007_01_23 , Jordan*/
...
CODE afacilitynames[] =
{
	...
	{"eulog", ALOG_AP_EU}, /*syslogd_2014_11_12 , Ken*/
	{ NULL, -1 }
};
#endif
